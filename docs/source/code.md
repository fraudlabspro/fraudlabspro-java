...
```{py:function} getTransaction(data)
Retrieve an existing transaction from FraudLabs Pro fraud detection system.

:param Hashtable data: (Required) The parameters of FraudLabs Pro transaction details.
...
:param Hashtable data: (Required) The parameters of order details.
...
```{py:function} validate(data)
Retrieve geolocation information for an IP address.

:param Hashtable data: (Required) The details of a transaction.
...
:param Hashtable data: (Required) Parameters of sms details.
